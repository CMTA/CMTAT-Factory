...
* deployed address.
*/
contract CMTAT_BEACON_FACTORY_Ownable2Step is CMTATStandardBeaconFactoryBase, CMTATFactoryOwnable2Step {
    /**
    ...
    */
    constructor(
        ...
        address beaconOwner,
        bool useCustomSalt_
    ) CMTATStandardBeaconFactoryBase(implementation_, beaconOwner, useCustomSalt_) Ownable(initialOwner) {}
