...
*/
contract CMTAT_BEACON_FACTORY is CMTATStandardBeaconFactoryBase, CMTATFactoryAccessControl {
    /**
    ...
    */
    constructor(
        ...
        CMTATStandardBeaconFactoryBase(implementation_, beaconOwner, useCustomSalt_)
