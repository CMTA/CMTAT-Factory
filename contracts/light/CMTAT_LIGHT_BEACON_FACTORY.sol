...
/**
* @notice Factory to deploy CMTAT behind a beacon proxy (CMTAT Light), gated by `CMTAT_DEPLOYER_ROLE`.
* @dev Role-based variant. For a single-owner deployment see `CMTAT_LIGHT_BEACON_FACTORY_Ownable2Step`; the two are
* chosen at deployment and are not interchangeable at a deployed address.
*/
contract CMTAT_LIGHT_BEACON_FACTORY is CMTATLightBeaconFactoryBase, CMTATFactoryAccessControl {
    /**
    ...
    */
    constructor(
        ...
        CMTATLightBeaconFactoryBase(implementation_, beaconOwner, useCustomSalt_)
